...
class LecturerProfileScreen extends StatefulWidget {
  ...
  @override
  State<LecturerProfileScreen> createState() => LecturerProfileScreenState();
}

class LecturerProfileScreenState extends State<LecturerProfileScreen> {
  @override
                  ...
                  children: [
                    ...
                    BlocBuilder<AuthBloc, AuthState>(
                      builder: (context, state) {
                        var auth = (state as AuthLecturer).data;
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(auth.nip.toString(),
                                    style:
                                        Theme.of(context).textTheme.bodySmall),
                                const SizedBox(width: 8),
                                GestureDetector(
                                  onTap: () => Clipboard.setData(
                                      ClipboardData(text: auth.nip.toString())),
                                  child: Icon(
                                    Iconsax.copy5,
                                    size: 16,
